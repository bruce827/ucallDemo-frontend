          ...
          >
            <FormItem name="category">
              <TagSelect expandable>
                <TagSelect.Option value="cat1">儿童意外险</TagSelect.Option>
                <TagSelect.Option value="cat2">儿童健康险</TagSelect.Option>
                <TagSelect.Option value="cat3">儿童教育基金保险</TagSelect.Option>
              </TagSelect>
            </FormItem>
          </StandardFormRow>
          {/* 所有者 */}
