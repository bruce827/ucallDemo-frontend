        ...
        tabBarExtraContent={
          <div className={styles.salesExtraWrap}>
            <div className={styles.salesExtra}>
              {/* <a className={isActive('today')?styles.currentDate:''} onClick={() => selectDate('today')}>
                <FormattedMessage
                  id="dashboardandanalysis.analysis.all-day"
                  defaultMessage="All Day"
                />
              </a> */}
              <a className={isActive('week')?styles.currentDate:''} onClick={() => selectDate('week')}>
                <FormattedMessage
                  id="dashboardandanalysis.analysis.all-week"
                  defaultMessage="All Week"
                />
              </a>
              <a className={isActive('month')?styles.currentDate:''} onClick={() => selectDate('month')}>
                <FormattedMessage
              ...
              {/* 默认为全年 */}
              <a className={isActive('year')?styles.currentDate:''} onClick={() => (selectDate('year'))}>
                <FormattedMessage
